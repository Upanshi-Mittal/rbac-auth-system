        ...
        <div className="container">
            <form className="form" onSubmit={sub}>
                ...
                <div className="role-container">
                    <button
                        type="button"
                        className={`roleButton ${signinfo.role === "user" ? "active" : ""}`}
                        onClick={() => setsigninfo({ ...signinfo, role: "user" })}
                    >
                        user
                    </button>
                    ...
                    <button
                        type="button"
                        className={`roleButton ${signinfo.role === "admin" ? "active" : ""}`}
                        onClick={() => setsigninfo({ ...signinfo, role: "admin" })}
                    >
                        Admin
                    </button>
                </div>
